...
\begin{figure}[H]
\centering
\subfigure[MNIST ACC trajectory]{\includegraphics[width=0.45\textwidth]{fig_noniid_untargeted_mnist_acc.pdf}}
\hfill
\subfigure[KDDCup99 ACC trajectory]{\includegraphics[width=0.45\textwidth]{fig_noniid_untargeted_kdd_acc.pdf}}
\subfigure[MNIST malicious-client TPR]{\includegraphics[width=0.45\textwidth]{fig_noniid_untargeted_mnist_tpr.pdf}}
\hfill
\subfigure[KDDCup99 malicious-client TPR]{\includegraphics[width=0.45\textwidth]{fig_noniid_untargeted_kdd_tpr.pdf}}
...
\begin{figure}[!htbp]
\centering
\subfigure[MNIST ACC trajectory]{\includegraphics[width=0.45\textwidth]{fig_iid_untargeted_mnist_acc.pdf}}
\hfill
\subfigure[KDDCup99 ACC trajectory]{\includegraphics[width=0.45\textwidth]{fig_iid_untargeted_kdd_acc.pdf}}
\subfigure[MNIST malicious-client TPR]{\includegraphics[width=0.45\textwidth]{fig_iid_untargeted_mnist_tpr.pdf}}
\hfill
\subfigure[KDDCup99 malicious-client TPR]{\includegraphics[width=0.45\textwidth]{fig_iid_untargeted_kdd_tpr.pdf}}
