...
\raggedbottom % diagram pages stack from the top; no mid-page stretch gaps
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth,height=0.70\textheight,keepaspectratio]{Algorithm_1_Flow_Diagram.pdf}}
    \caption{Setup and key-distribution flow of Algorithm~\ref{alg:fip-ppfl-init}.}
    \label{fig:alg1-flow}
\end{figure}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth,height=0.70\textheight,keepaspectratio]{Algorithm_2_Flow_Diagram.pdf}}
    \caption{Phase~I client pipeline of Algorithm~\ref{alg:fip-client-submit}.}
    \label{fig:alg2-flow}
\end{figure}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth,height=0.70\textheight,keepaspectratio]{Algorithm_3_Flow_Diagram.pdf}}
    \caption{Phase~II homomorphic scoring of Algorithm~\ref{alg:fip-score}.}
    \label{fig:alg3-flow}
\end{figure}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth,height=0.70\textheight,keepaspectratio]{Algorithm_4_Flow_Diagram.pdf}}
    \caption{Phase~III bootstrap-stage audit of Algorithm~\ref{alg:stage1_audit}.}
    \label{fig:alg4-flow}
\end{figure}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth,height=0.70\textheight,keepaspectratio]{Algorithm_5_Flow_Diagram.pdf}}
    \caption{Phases~IV--V secure aggregation and model update of Algorithm~\ref{alg:secure_aggregation}.}
    \label{fig:alg5-flow}
\end{figure}
...
\flushbottom % restore default vertical justification for the following chapters
